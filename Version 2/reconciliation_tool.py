...
class ReconciliationApp:
    ...
    def create_widgets(self):
        ...
        # Title (left) + Settings gear button (top right) share row 0
        ...
        if not self.embedded:
            # When embedded in the multi-tool shell, Settings is opened from
            # the sidebar instead, so this in-page button stays hidden.
            self.settings_button.grid(row=0, column=1, pady=(0, 5), sticky="ne")

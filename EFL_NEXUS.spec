...
binaries = []
hiddenimports = ['pandas', 'openpyxl', 'openpyxl.styles', 'requests', 'dotenv', 'korber_tool', 'reconciliation_tool', 'korber_login_bot', 'outlook_email_gui', 'KPI', 'kpi_profile', 'reconciliation_queue', 'website_data_grabber', 'patch_auditship_credentials', 'gspread', 'oauth2client', 'oauth2client.service_account', 'updater', 'win32com', 'win32com.client', 'pythoncom', 'win32api', 'winreg', 'customtkinter', 'queue', 'hashlib', 'calendar']
hiddenimports += ['webview', 'webview.platforms.edgechromium', 'clr_loader', 'pythonnet', 'win32cred']
tmp_ret = collect_all('selenium')
datas += tmp_ret[0]; binaries += tmp_ret[1]; hiddenimports += tmp_ret[2]
